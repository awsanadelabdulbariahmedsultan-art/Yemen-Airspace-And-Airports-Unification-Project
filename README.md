...
```mermaid
graph TD
    classDef main Hub,fill:#2d3748,stroke:#4a5568,stroke-width:2px,color:#fff;
    classDef feeder fill:#1a202c,stroke:#2d3748,stroke-width:1px,color:#cbd5e0;

    GLOBAL[🌐 خطوط الملاحة الجوية العالمية] --> SAN[✈️ مطار صنعاء الدولي الجديد - جدر]
    GLOBAL --> ADE[🚢 مطار عدن الدولي]
    
    SAN --- |محور ركاب وترانزيت عالمي| ADE
    ADE --- |محور لوجستي وشحن جوي بحري| SAN

    SAN --> FEEDERS[🔗 شبكة المطارات المحلية المغذية الموحدة]
    ADE --> FEEDERS

    FEEDERS --> TAIZ[مطار تعز الدولي - كثافة سكانية وركاب]
    FEEDERS --> HOD[مطار الحديدة الدولي - شحن زراعي وسمكي]
    FEEDERS --> SEI[مطار سيئون الدولي - قطاع نفطي وركاب]
    FEEDERS --> MOK[مطار المخا - دعم لوجستي وباب المندب]
    FEEDERS --> RIY[مطار الريان المكلا - صادرات واقتصاد أزرق]
    FEEDERS --> GHA[مطار الغيضة المهرة - تجارة بينية وحدودية]
    
    FEEDERS --> SOC[🏝️ مطار سقطرى الدولي - بوابة السياحة البيئية العالمية]

    class SAN,ADE main;
    class TAIZ,HOD,SEI,MOK,RIY,GHA,SOC feeder;
```
...
جدول_الخطوات_التنفيذية:
  من_الساعة_00_إلى_12:
    الجراد_المطلوب: "توقيع وثيقة اتفاقية تحييد الأجواء والمطارات فوراً من القيادات السياسية والفنية في صنعاء وعدن."
    الحالة: "حرج للغاية"
  من_الساعة_12_إلى_24:
    الجراء_المطلوب: "النشر الرقمي الفوري لخرائط المسارات الجوية المحدثة عبر تعميم الـ NOTAM الدولي لجميع الطيارين."
    الحالة: "إلزامي"
  ساعة_الصفر_المستهدفة:
    الجراء_المطلوب: "الفتح الشامل للأجواء اليمنية وعودة حجز التذاكر التجارية الدولية وتفعيل عوائد رسوم العبور."
...
graph TD
    ...
    GLOBAL[🌐 GLOBAL AIR TRAFFIC CORRIDORS] --> SAN[✈️ SANA'A NEW AIRPORT - JADR]
    GLOBAL --> ADE[🚢 ADEN INTERNATIONAL AIRPORT]
    
    SAN --- |Passenger & Transit Hub| ADE
    ADE --- |Global Sea-Air Cargo Hub| SAN

    SAN --> FEEDERS[🔗 INTEGRATED DOMESTIC FEEDER SYSTEM]
    ADE --> FEEDERS

    FEEDERS --> TAIZ[Taiz Intl - Demographics]
    FEEDERS --> HOD[Hodeidah Intl - Agri-Cargo]
    FEEDERS --> SEI[Seiyun Intl - Oil Sector]
    FEEDERS --> MOK[Al Mokha - Bab-el-Mandeb]
    FEEDERS --> RIY[Riyan Mukalla - Blue Economy]
    FEEDERS --> GHA[Al Ghaydah - Cross-Border]
    
    FEEDERS --> SOC[🏝️ SOCOTRA INTL - Eco-Tourism Gateway]
